...
[ ] = { { ( char_T * ) ( & rtB . kwx2wq3sbg ) , 0 , 0 , 5 } , { ( char_T * )
( & rtDW . embnbxlj4s . LoggedData [ 0 ] ) , 11 , 0 , 2 } , { ( char_T * ) (
& rtDW . cad043p41y ) , 10 , 0 , 2 } } ; static DataTypeTransitionTable
rtBTransTable = { 3U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . den [ 0 ] ) , 0 , 0 , 23 } }
